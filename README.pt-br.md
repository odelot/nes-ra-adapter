...
- **Testes com diferentes jogos**: Testamos o adaptador com mais de 50 jogos. Consulte a [página de compatibilidade](Compatibility.md) para mais detalhes, vale lembrar que a tabela foi preenchida na fase do protótipo v0.2, então algumas linhas (como o problema de boot do Castlevania, corrigido na 1.2) não refletem mais o firmware atual.
